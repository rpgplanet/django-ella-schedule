...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ellaschedule_event', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.start'
        db.alter_column('ellaschedule_event', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))
